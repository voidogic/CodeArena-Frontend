    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200"> {/* Added a light bg for contrast */}
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title justify-center text-3xl mb-6">CodeShaala</h2> {/* Added mb-6 for spacing */}
...
export default Signup;
    ...
    //     return (
    //         <>
    //             <form onSubmit={handleSubmit(submittedData)} className="flex flex-col justify-center items-center gap-y-3 min-h-screen">
    ...
    //                 {errors.emailId && (<span>{errors.email.message}</span>)}
